...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'carcontrol' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/delorean/catkin_ws/install/${idir}'.  Ask the maintainer 'delorean <delorean@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/delorean/catkin_ws/install/lib;/home/delorean/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
