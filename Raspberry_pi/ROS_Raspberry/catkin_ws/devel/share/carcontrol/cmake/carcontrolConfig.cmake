...
if("TRUE" STREQUAL "TRUE")
  set(carcontrol_SOURCE_PREFIX /home/delorean/Escritorio/GitHub/2015-ieee-delorean/Raspberry_pi/ROS_Raspberry/catkin_ws/src/carcontrol)
  set(carcontrol_DEVEL_PREFIX /home/delorean/Escritorio/GitHub/2015-ieee-delorean/Raspberry_pi/ROS_Raspberry/catkin_ws/devel)
  ...
  set(carcontrol_INSTALL_PREFIX /home/delorean/Escritorio/GitHub/2015-ieee-delorean/Raspberry_pi/ROS_Raspberry/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'carcontrol' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'delorean <delorean@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'carcontrol' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/delorean/Escritorio/GitHub/2015-ieee-delorean/Raspberry_pi/ROS_Raspberry/catkin_ws/src/carcontrol/${idir}'.  Ask the maintainer 'delorean <delorean@todo.todo>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${carcontrol_dep}_FOUND)
      find_package(${carcontrol_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${carcontrol_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
