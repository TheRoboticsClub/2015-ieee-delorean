!function(e) {
    function t() {
        this._events = {},
        this._conf && i.call(this, this._conf)
    }
    function i(e) {
        e && (this._conf = e,
    ...
    function n(e, t, i, s) {
        if (!i)
            return [];
        var r, l, o, h, a, f, c, _ = [], p = t.length, u = t[s], v = t[s + 1];
        if (s === p && i._listeners) {
            if ("function" == typeof i._listeners)
                return e && e.push(i._listeners),
                [i];
            for (r = 0,
            l = i._listeners.length; r < l; r++)
        ...
        if ("*" === u || "**" === u || i[u]) {
            if ("*" === u) {
                for (o in i)
                    "_listeners" !== o && i.hasOwnProperty(o) && (_ = _.concat(n(e, t, i[o], s + 1)));
                return _
            }
            if ("**" === u) {
                (c = s + 1 === p || s + 2 === p && "*" === v) && i._listeners && (_ = _.concat(n(e, t, i, p)));
                for (o in i)
                    "_listeners" !== o && i.hasOwnProperty(o) && ("*" === o || "**" === o ? (i[o]._listeners && !c && (_ = _.concat(n(e, t, i[o], p))),
                    _ = _.concat(n(e, t, i[o], s))) : _ = o === v ? _.concat(n(e, t, i[o], s + 2)) : _.concat(n(e, t, i[o], s)));
                return _
            }
        ...
        a = i["**"])
            if (s < p) {
                ...
                for (o in a)
                    "_listeners" !== o && a.hasOwnProperty(o) && (o === v ? n(e, t, a[o], s + 2) : o === u ? n(e, t, a[o], s + 1) : ((f = {})[o] = a[o],
                    n(e, t, {
                        "**": f
                    }, s + 1)))
            } else
                a._listeners ? n(e, t, a, p) : a["*"] && a["*"]._listeners && n(e, t, a["*"], p);
        return _
    }
    function r(e, t) {
        ...
        for (var n = this.listenerTree, r = e.shift(); r; ) {
            ...
            0 === e.length) {
                if (n._listeners) {
                    ...
                    else if (l(n._listeners) && (n._listeners.push(t),
                    !n._listeners.warned)) {
                        var h = o;
                        void 0 !== this._events.maxListeners && (h = this._events.maxListeners),
                        h > 0 && n._listeners.length > h && (n._listeners.warned = !0,
                        console.error("(node) warning: possible EventEmitter memory leak detected. %d listeners added. Use emitter.setMaxListeners() to increase limit.", n._listeners.length),
                        console.trace())
                    }
                } else
                    n._listeners = t;
    ...
    s.prototype.emit = function() {
        ...
        if (this._all) {
            for (var i = arguments.length, s = new Array(i - 1), r = 1; r < i; r++)
                s[r - 1] = arguments[r];
            for (r = 0,
            i = this._all.length; r < i; r++)
                this.event = e,
                this._all[r].apply(this, s)
        }
        if ("error" === e && !(this._all || this._events.error || this.wildcard && this.listenerTree.error))
    ...
    s.prototype.on = function(e, i) {
        ...
        if (this._events[e]) {
            ...
            else if (l(this._events[e]) && (this._events[e].push(i),
            !this._events[e].warned)) {
                var s = o;
                void 0 !== this._events.maxListeners && (s = this._events.maxListeners),
                s > 0 && this._events[e].length > s && (this._events[e].warned = !0,
    ...
    s.prototype.off = function(e, t) {
        ...
        for (var o = 0; o < s.length; o++) {
            ...
            l(i)) {
                ...
                0 === i.length && (this.wildcard ? delete h._listeners : delete this._events[e]),
                this
            }
    ...
    s.prototype.removeAllListeners = function(e) {
        if (0 === arguments.length)
            return !this._events || t.call(this),
            this;
        if (this.wildcard)
            for (var i = "string" == typeof e ? e.split(this.delimiter) : e.slice(), s = n.call(this, null, i, this.listenerTree, 0), r = 0; r < s.length; r++)
                s[r]._listeners = null;
        else {
            if (!this._events[e])
                return this;
    ...
    s.prototype.listeners = function(e) {
        if (this.wildcard) {
            ...
            return n.call(this, i, s, this.listenerTree, 0),
            i
        }
        return this._events || t.call(this),
